                ...
                <div class="box box-solid">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="callout callout-info">
                                    <p>
                                        <i class="mdi mdi-information-outline"></i>&nbsp;&nbsp;<?= Translate::sprint("What's the purpose of using custom fields in my app ?") ?>
                    ...
                    <div class="box-footer">
                        <button id="save-cf" class="btn btn-primary btn-flat pull-right"><i
                                    class="mdi mdi-content-save-outline"></i>&nbsp;&nbsp;<?= _lang("Add field") ?>
                        </button>
                    </div>
                </div>
                <!-- /.box -->
