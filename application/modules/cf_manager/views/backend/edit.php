                ...
                <div class="box box-solid">
                            ...
                            <div class="col-sm-8">
                                            ...
                                            <tr class="line line_<?= $d ?> edit" data-id="<?= $d ?>">
                                                ...
                                                <td valign="center">
                                                    <div class="form-group no-padding">
                                                        <label><input type="radio" class="required is_required"
                                                                      name="is_required_<?= $d ?>"
                                                                      value="1" <?= ($field['required'] == 1) ? "checked" : "" ?>/>&nbsp;&nbsp;<?= _lang("Yes") ?>
                                                        </label>&nbsp;&nbsp;
                                                        <label><input type="radio" class="required"
                                                                      name="is_required_<?= $d ?>"
                                                                      value="0" <?= ($field['required'] == 0) ? "checked" : "" ?>/>&nbsp;&nbsp;<?= _lang("No") ?>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td align="right"><a class="remove cursor-pointer"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="cf_label"
                                           placeholder="<?= _lang("Enter label...") ?>" value="<?= $data['label'] ?>">
                                </div>
                    ...
                    <div class="box-footer">
                        <button id="save-cf" class="btn btn-primary btn-flat pull-right"><i
                                    class="mdi mdi-content-save-outline"></i>&nbsp;&nbsp;<?= _lang("Save changes") ?>
                        </button>
                    </div>
                </div>
                <!-- /.box -->
