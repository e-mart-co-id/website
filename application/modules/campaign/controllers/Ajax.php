...
class Ajax extends AJAX_Controller  {
    ...
    public function saveCampaignConfig(){
        ...
        $RADUIS_TRAGET = $this->input->post("RADUIS_TRAGET");
        $LIMIT_PUSHED_GUESTS_PER_CAMPAIGN = $this->input->post("LIMIT_PUSHED_GUESTS_PER_CAMPAIGN");
        $PUSH_CAMPAIGNS_WITH_CRON = $this->input->post("PUSH_CAMPAIGNS_WITH_CRON");
        $NBR_PUSHS_FOR_EVERY_TIME = $this->input->post("NBR_PUSHS_FOR_EVERY_TIME");
        $_NOTIFICATION_AGREEMENT_USE = $this->input->post("_NOTIFICATION_AGREEMENT_USE");
    ...
    public function getEstimation(){
        ...
        $custom_parameters =  $this->input->post("custom_parameters");
        $module_name =  $this->input->post("module_name");
    ...
    public function createCampaign(){
        ...
        $custom_title =  $this->input->post("campaign_name");
        $custom_text =  $this->input->post("campaign_text");
