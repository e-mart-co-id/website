                        ...
                        <div class="box-body">
                            ...
                            <?php  foreach (CampaignManager::load() as $key => $module): ?>
                                ...
                                if(isset($module['custom_parameters']) && isset($module['custom_parameters']['html'])){
                                    ...
                                    TemplateManager::addScript($module['custom_parameters']['script']);
                                }
                            ...
                            <div class="form-group box-estimation hidden">
                                ...
                                <br>
                                <span> <?=Translate::sprintf("This campaign will target %s customers",array("<span class=\"target_value\">0</span>",RADUIS_TRAGET),"")?> </span><br/>
                                <?php if(_NOTIFICATION_AGREEMENT_USE):?>
                                <span class="text-blue"><i class="mdi mdi-information-outline"></i> <?=Translate::sprintf("You will only target users who are interested in your business")?>. </span>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="previews-container">
                                <div class="android-preview device-preview">
                                    ...
                                    <div class="preview-background android" style="background-image: url(<?=TemplateManager::assets("campaign", "images/android.png")?>)">
                                        <div class="card-notification">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td width="65px">
                                                        <img data-placeholder="<?=TemplateManager::assets("campaign", "images/device_image_placeholder.png")?>" class="notification-image" src="<?=TemplateManager::assets("campaign", "images/device_image_placeholder.png")?>"/>
                                                    </td>
                                                    <td>
                                ...
                                <div class="ios-preview device-preview">
                                    ...
                                    <div class="preview-background ios" style="background-image: url(<?=TemplateManager::assets("campaign", "images/iphone.png")?>)">
                                        <div class="card-notification">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td>
