...
class Modules_manager extends MAIN_Controller {
    ...
    public function onCommitted($isEnabled)
    {
        ...
        TemplateManager::addHtml($this->load->view("modules_manager/module_install/verification_pid",NULL,TRUE));
        ...
        if(GroupAccess::isGranted('modules_manager') && $this->check_need_upgrade() && !DEMO){
            NotesManager::addNew(
    ...
    private function upadateAlert(){
        return '<div class="callout callout-warning">
            ...
            <h5>Some modules need to be upgraded.y</h5>
