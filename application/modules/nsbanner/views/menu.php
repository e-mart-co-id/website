...
<?php if (GroupAccess::isGranted('nsbanner')): ?>
    ...
    <li class="treeview <?php if ($uri_m == "nsbanner") echo "active"; ?>">
        <a href="<?= admin_url("nsbanner/all") ?>"><i class="mdi mdi-receipt"></i> &nbsp;
            <span><?= Translate::sprint("Banners") ?> </span>
