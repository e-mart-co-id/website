                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body box-title">
                        ...
                        <div class="box-title">
                            ...
                            &nbsp;&nbsp;<a data-toggle="modal" data-target="#add-balance-modal" href="#"><i class="mdi mdi-plus"></i><?=_lang("Add Balance")?></a>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b><?=_lang("Add Balance!")?></b></h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?=Translate::sprint("Cancel","Cancel")?></button>
                <button type="button" id="add_balance" class="btn btn-flat btn-primary"><?=Translate::sprint("Add Balance")?></button>
            </div>
        </div>
