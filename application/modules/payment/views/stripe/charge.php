        ...
        <div class="row payment">
            ...
            <div class="col-sm-8">
                ...
                <form action="<?=site_url("payment/stripe_api/create_payment_with_stripe")?>" method="post" id="payment-form">
                    <div class="form-row">
                        <h1 for="card-element"><i class="fa fa-cc-stripe"></i>&nbsp;&nbsp;<?=_lang("Credit or debit card")?></h1>
                        <p><?=_lang("Pay with credit or debit card by using stripe.com")?></p><br><br>
                        <div id="card-element">
                    ...
                    <button class="btn btn-primary" id="pay-now"><?=_lang("Submit Payment")?></button>
                </form>
            </div>
            <div class="col-sm-2"></div>
        </div>
