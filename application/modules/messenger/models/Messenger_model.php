...
class Messenger_model extends CI_Model {
    ...
    public function getMessengerAnalytics($months = array(),$owner_id=0){
        ...
        $analytics['count_label'] = Translate::sprint("Total_discussions");
        $analytics['color'] = "#ff0061";
        $analytics['icon_tag'] = "<i class=\"mdi mdi-comment-multiple-outline\"></i>";
    ...
    public function sendMessage($params=array()){
        ...
        if(isset($sender_id) && $sender_id>0
            ...
            if(count($messages)==0){
                ...
                //$date_sent  = MyDateUtils::convert(    date("Y-m-d H:i:s",time()),TimeZoneManager::getTimeZone(),"UTC");
