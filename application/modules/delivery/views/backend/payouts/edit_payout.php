            ...
            <div class="col-sm-12">
                <div class="box box-solid">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="status" class="form-control select2 status"
                                            style="width: 100%;" <?=$payout['status']=="cancel"?"disabled":""?>>
                                        ...
                                        <option  value="cancel"><?= Translate::sprint("Cancel") ?></option>
                                    </select>
                                </div>
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn  btn-primary pull-right" id="btnEdit" <?=$payout['status']=="cancel"?"disabled":""?>><span
...
$data['id'] = $payout['id'];
$data['payout'] = $payout;
$script = $this->load->view('delivery/backend/payouts/scripts/edit-payout-script', $data, TRUE);
