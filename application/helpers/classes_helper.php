...
//MESSAGES
    ...
    class Messages {
        ...
        const EXCEEDED_MAX_NBR_PRODUCTS = "You have exceeded the maximum number of products";
        ...
        const METHOD_NOT_SELECTED = "Payment method not selected";
        const STATUS_NOT_SELECTED = "Payment status not selected";
        const AMOUNT_NOT_SELECTED = "The amount is not filled in";
