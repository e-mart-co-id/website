...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['views/skin/backend/plugins/daterangepicker/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('views/skin/backend/plugins/daterangepicker/moment');
    var jQuery;
    try {
